...
$('#people>div>table')
.append($('<tr/>')
	.append($('<td/>').append($('<a/>').text(people[x].givenName + people[x].familyName).attr('href','./cp/people/' + people[x]['@id'])))
...
.append($('<tr/>')
	.append($('<td/>').append($('<a/>').text(repos[x].repositoryName).attr('href','./cp/repositories/' + repos[x].orgidentifier)))
	.append($('<td/>').append($('<a/>').text(repos[x].repositoryURL).attr('href',repos[x].repositoryURL)))
.append($('<td/>').text(repos[x].lastUpdate)).attr('onmouseover','showDets(\"./cp/repositories/' + repos[x].orgidentifier +'\", ' + '\"#repositoriesDetails\")')
);
}
...
.append($('<td/>').append($('<div/>').text(statusArray[statusArray.length-1].date)))
	.append($('<td/>').append($('<div/>').text(requests[x].Repository))).attr('onmouseover','showDets(\"./cp/researchobjects/' + requests[x].Aggregation.Identifier +'\", ' + '\"' + anchor + 'Details\")'));
}
